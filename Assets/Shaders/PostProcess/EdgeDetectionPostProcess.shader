Shader "Fullscreen/EdgeDetection"
{
    Properties
    {
        ...
        _ChromaticSpread ("Chromatic Spread", Range(0, 10)) = 3.0
        _ChromaticIntensity ("Chromatic Intensity", Range(0, 1)) = 0.8
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                chromaDistanceFactor = chromaDistanceFactor * chromaDistanceFactor; // Smooth falloff
                ...
                // Create offset samples for RGB channels at different distances
                ...
                // Apply distance factor and intensity to chromatic channels
                ...
                // Remove white edge from chromatic channels (so they appear outside the white edge)
                ...
                // Add chromatic aberration (outside white edge)
